...
module.exports = {
	...
	componentDidMount: function () {
		this.props.dndStore.updateStream.on("update", this.onDnDUpdate);
		this.props.expandedStore.updateStream.on("update", this.onExpandedUpdate);
	},

	componentWillUnmount: function () {
		this.props.dndStore.updateStream.removeListener("update", this.onDnDUpdate);
		this.props.expandedStore.updateStream.removeListener("update", this.onExpandedUpdate);
	},
	...
	relevantItemRenderList: function () {
		return this.props.elementsExtractor(this.props.dndStore.relevantStateFor(this.props.tree));
	},

	renderItem: function (item, index) {
		return this.props.viewFactory.element(item, assign({}, this.props, {
	...
	renderStub: function () {
		var that = this;
		return React.createElement("div", { className: "stub-renderer",
