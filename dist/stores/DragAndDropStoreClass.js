 ...
 * @constructor
 */
var DragAndDropStore = function (dispatcher, identifier, elementsExtractor, elementsUpdater) {
...
DragAndDropStore.prototype = {
	...
	_register: function () {
		this._dispatcher.register(ActionTypes.DRAG_START_EXISTING, this._onDragStartExisting, this);
		this._dispatcher.register(ActionTypes.DRAG_START_NEW, this._onDragStartNew, this);
		this._dispatcher.register(ActionTypes.DRAG_OVER, this._onDragOver, this);
		this._dispatcher.register(ActionTypes.DRAG_END, this._onDragEnd, this);
	},

	_reset: function () {
		this.dragType = DragType.NONE;
		this.elementDragged = this.elementUnderDragged = this.target = this.source = null;
	},
  ...
  */
	_removeFromSource: function () {
		if (this.source) {
			this.source.after = this._elementsUpdater(this.source.after, IU.removeInList(this._mutatedSourceList(), this.elementDragged));
		}
	},
  ...
  */
	_insertInTarget: function () {
		this.target.after = this._elementsUpdater(this.target.after, IU.insertAt(this._mutatedTargetList(), this.elementDragged, this._underDraggedIndex()));
	},
  ...
  */
	_reorderElements: function () {
		this.target.after = this._elementsUpdater(this.target.after, IU.moveInList(this._mutatedTargetList(), this._draggedIndex(), this._underDraggedIndex()));
	},
  ...
  */
	isInvolvedInDragOperations: function (object) {
		return this.isDragOperationSource(object) || this.isDragOperationTarget(object);
	},
	...
	isMutatedSource: function (object) {
		return this.isDragOperationSource(object) && this.isSourceMutated();
	},

	isMutatedTarget: function (object) {
		return this.isDragOperationTarget(object) && this.isTargetMutated();
	},
  ...
  */
	isMutatedByDragOperations: function (object) {
		return this.isMutatedSource(object) || this.isMutatedTarget(object);
	},
