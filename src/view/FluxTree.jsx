...
module.exports = React.createClass({
	...
	getInitialState: function () {
		...
		var dndStore = new DNDStore(
			dispatcher,
			this.props.identifier,
			this.props.elementsExtractor,
			this.props.elementsUpdater
		);
		...
		return {
			...
			expandedStore: new ExpandedStore(
				dispatcher,
				this.props.identifier
			),
			dndStore: dndStore,
			...
			viewFactory: new TreeViewFactory(
				this.props.leafRenderer,
				this.props.treeRenderer,
				this.props.typeExtractor
			)
		};
	},
	...
	componentWillUnmount: function () {
		this.state.dataStore.dataStream.removeListener('update',
	...
	componentWillReceiveProps: function (nextProps) {
		...
		if (nextProps.leafRenderer !== this.props.leafRenderer ||
			nextProps.treeRenderer !== this.props.treeRenderer) {
			this.state.viewFactory = new TreeViewFactory(
				this.props.leafRenderer, this.props.treeRenderer
			);
		}
	},
